                ...
                <form @submit.prevent="submitForm" class="mt-6">
                  ...
                  <div class="mt-4">
                    ...
                    <input
                      ...
                      :class="{ 'border-red-500': error }"
                      class="w-[90%] h-10 my-2 py-3 px-4 block border-2 bg-black text-white border-gray-200 rounded-md text-sm focus:border-green-500 focus:ring-green-500 shadow-sm">
