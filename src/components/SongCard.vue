<template>
    ...
    <div @contextmenu.prevent="doSomething">
        <div class="bg-[#181818] hover:bg-[#282828] pr-4 pl-4 rounded-md m-2 shadow-xl cursor-pointer h-[250px] w-[110px] sm:h-[270px] sm:w-[180px] sm:pt-4 group transition-all duration-300 ease-in-out">
