        ...
        >
            ...
            >
                <div class="px-1 py-1">
                    ...
                    >
                        Agregar a cola
                        <svg class="w-5 h-5 text-white ml-[52px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 21 18">
                    ...
                    >
                        Agregar a playlist
                        <svg class="w-5 h-5 text-white ml-[38px] mt-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 16">
                    ...
                    <MenuItem v-if="props.playlist.user_id === mainStore.user?.id"  v-slot="{ active }">
                    <button
