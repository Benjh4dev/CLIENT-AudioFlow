              ...
              <DialogPanel class="flex transform overflow-hidden rounded-2xl bg-black p-6 shadow-xl transition-all">
                <div class="bg-black p-4 rounded-lg shadow-md">
                    ...
                    <div class="mt-4 flex justify-end">
                        <button @click="closeModal" class="px-3 py-1 mr-2 bg-gray-300 text-gray-700 rounded hover:bg-gray-400">Cancelar</button>
                        <button @click="confirmModal" class="px-3 py-1 bg-red-500 text-white rounded hover:bg-red-600">Confirmar</button>
                    </div>
                </div>
