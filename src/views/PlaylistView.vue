<template>
    <div role="status" class="flex items-center justify-center h-[70vh] xl:h-[80vh] transition-opacity duration-300"
        :class="{ 'visible': isLoading, 'hidden': !isLoading }">
        <svg aria-hidden="true" class="w-40 h-40 text-gray-600 animate-spin fill-green-600" viewBox="0 0 100 101"
